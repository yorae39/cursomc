...
insert into Produto (id, nome, preco) values (null, 'Cadeira secretária', 120.00);
insert into Produto (id, nome, preco) values (null, 'Lençol', 30.00);
insert into Produto (id, nome, preco) values (null, 'Edredon', 80.00);
insert into Produto (id, nome, preco) values (null, 'Toalhas', 40.00);
insert into Produto (id, nome, preco) values (null, 'Perfume Masculino Quasar', 70.00);
insert into Produto (id, nome, preco) values (null, 'Perfume Feminino Timeless', 90.00);
insert into Produto (id, nome, preco) values (null, 'Perfume Infantil Baby & Cia', 90.00);
insert into Produto (id, nome, preco) values (null, 'Quadro Muralha da China', 100.00);
-- -------------------------------------------------------------
...
insert into Produto_Categoria (produto_id, categoria_id) values (8,7);
insert into Produto_Categoria (produto_id, categoria_id) values (9,7);
insert into Produto_Categoria (produto_id, categoria_id) values (10,7);
insert into Produto_Categoria (produto_id, categoria_id) values (11,6);
-- -------------------------------------------------------------
